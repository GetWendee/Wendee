...
<div class="page">
    ...
    <div class="titre">
        ...
        <h1>Mandat de courtage en garantie accident de la vie</h1>
    </div>
    ...
    <p class="corps-paragraphe">Le présent mandat confie au Courtier la recherche, la négociation et le suivi d'un contrat de garantie des accidents de la vie (GAV) destiné à indemniser le Mandant et les personnes désignées en cas d'invalidité consécutive à un accident de la vie privée non pris en charge par un autre régime. Le Courtier s'engage à analyser les besoins du Mandant et à lui proposer des garanties adaptées parmi les offres des compagnies d'assurance partenaires.</p>
    ...
    <ul class="corps-liste">
        ...
        <li>Réaliser une analyse objective des besoins avant toute recommandation, en tenant compte des garanties déjà couvertes par ailleurs (assurance scolaire, responsabilité civile, contrats existants).</li>
        ...
        <li>Fournir des explications claires sur le seuil d'intervention, les exclusions et le mode de calcul de l'indemnisation.</li>
        <li>Assister le Mandant dans la souscription et le suivi du contrat.</li>
    </ul>

    <div class="section-title">5. Obligations du Mandant</div>
    <p class="corps-paragraphe">Le Mandant s'engage à fournir des informations exactes et complètes sur sa situation, celle des personnes à couvrir et les activités pratiquées, et à informer sans délai le Courtier de toute modification pouvant impacter le contrat.</p>
    ...
    <div class="recueil-sous-titre">Activités pratiquées à risque</div>
    <table class="recueil-table">
        <tr><td class="recueil-label">Activités</td><td>{{ $recueil['activites_a_risque_libelle'] ?? 'Aucune' }}</td></tr>
        @if(!empty($recueil['activite_autre_precision']))
        <tr><td class="recueil-label">Précision</td><td>{{ $recueil['activite_autre_precision'] }}</td></tr>
        @endif
    </table>
    ...
    <div class="recueil-sous-titre">Seuil d'intervention et capital</div>
    <table class="recueil-table">
        <tr><td class="recueil-label">Taux d'invalidité minimum</td><td>{{ $recueil['seuil_intervention_libelle'] ?? '-' }}</td></tr>
        <tr><td class="recueil-label">Capital souhaité en cas d'invalidité totale</td><td>{{ $recueil['capital_invalidite_totale'] ?? '-' }} €</td></tr>
    </table>
