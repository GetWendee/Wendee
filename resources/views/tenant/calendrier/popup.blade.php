...
<head>
    ...
    <style>
        *{box-sizing:border-box}
        html,body{margin:0;background:#f3f1ee;font-family:'Montserrat',sans-serif}
        .wd-wrap{max-width:480px;margin:0 auto;padding:24px 20px;}
        .wd-head{margin-bottom:20px;}
        .wd-eyebrow{font-size:11px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;color:#817b76;margin-bottom:6px;}
        .wd-head h1{font-size:20px;font-weight:800;color:#151515;margin:0;}
        .wd-cal-card{background:#fff;border:1px solid #ded9d4;border-radius:14px;padding:18px;display:flex;align-items:center;justify-content:space-between;gap:14px;margin-bottom:14px;}
        .wd-cal-info{display:flex;align-items:center;gap:14px;min-width:0;}
        .wd-cal-logo{width:40px;height:40px;border-radius:12px;background:#f3f1ee;display:flex;align-items:center;justify-content:center;font-weight:800;color:#151515;flex-shrink:0;}
        .wd-cal-name{font-size:14px;font-weight:700;color:#151515;}
        .wd-cal-status{font-size:12px;color:#817b76;margin-top:2px;overflow-wrap:anywhere;}
        .wd-cal-status.connected{color:#4d8760;font-weight:600;}
        .wd-btn{display:inline-flex;align-items:center;padding:9px 16px;border-radius:999px;font-size:12.5px;font-weight:700;cursor:pointer;border:none;text-decoration:none;flex-shrink:0;}
        .wd-btn-dark{background:#1b1716;color:#fff;}
        .wd-btn-outline{background:#fff;color:#b94d4d;border:1px solid #ded9d4;}
        .wd-status-msg{background:#eaf3ec;color:#316b45;border-radius:10px;padding:12px 16px;font-size:13px;margin-bottom:16px;}
        .wd-note{font-size:12px;color:#817b76;margin-top:16px;}
    </style>
</head>
<body>
<div class="wd-wrap">
